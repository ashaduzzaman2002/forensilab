    ...
    <footer className="bg-white text-foreground">
      <div className="mx-auto max-w-7xl px-4 py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div>
            <Link href="/"><Image src="/fL logo-01.png" alt="ForensiLabs Logo" width={120} height={80} /></Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {data.quickLinks.map((link: any) => (
                <li key={link.label}><Link href={link.href} className="text-sm text-foreground hover:text-primary">{link.label}</Link></li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-3">
              {data.socialLinks?.facebook && (
                <a href={data.socialLinks.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="flex size-9 items-center justify-center rounded-full border border-border text-foreground hover:bg-muted hover:text-primary">
              ...
              {data.socialLinks?.twitter && (
                <a href={data.socialLinks.twitter} target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="flex size-9 items-center justify-center rounded-full border border-border text-foreground hover:bg-muted hover:text-primary">
              ...
              {data.socialLinks?.linkedin && (
                <a href={data.socialLinks.linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="flex size-9 items-center justify-center rounded-full border border-border text-foreground hover:bg-muted hover:text-primary">
              ...
              {data.socialLinks?.instagram && (
                <a href={data.socialLinks.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="flex size-9 items-center justify-center rounded-full border border-border text-foreground hover:bg-muted hover:text-primary">
        ...
        <div className="flex flex-col items-center justify-between gap-4 text-sm text-foreground sm:flex-row">
          <p>© {new Date().getFullYear()} ForensiLabs. All rights reserved.</p>
