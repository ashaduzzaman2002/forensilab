...
export function TeamList({ items }: { items: Item[] }) {
  ...
  function handleDelete() {
    ...
    startTransition(async () => {
      const r = await deleteTeamMember(deleteId);
      setDeleteId(null);
      ...
      <AlertDialog open={!!deleteId} onOpenChange={(open) => { if (!open) setDeleteId(null); }}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>Are you sure you want to delete this team member? This action cannot be undone.</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
