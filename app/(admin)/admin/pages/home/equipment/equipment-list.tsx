  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-end">
        <Link href="/admin/pages/home/equipment/add" className="inline-flex items-center gap-2 rounded-lg bg-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground shadow-md shadow-primary/20 transition hover:bg-primary/90">
      ...
      {items.length === 0 ? (
        <div className={`${cardClass} p-12 text-center`}>
          ...
          <p className="mt-3 text-sm text-muted-foreground">No equipment yet.</p>
        </div>
      ) : (
