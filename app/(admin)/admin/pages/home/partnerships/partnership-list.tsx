...
export function PartnershipList({ items }: { items: Item[] }) {
  ...
  function handleDelete() {
    ...
    startTransition(async () => {
      const res = await deletePartnership(deleteId);
      setDeleteId(null);
      ...
      <AlertDialog open={!!deleteId} onOpenChange={(open) => { if (!open) setDeleteId(null); }}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>Are you sure you want to delete this partnership? This action cannot be undone.</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
